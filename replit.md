...
- **Project Management (Initiative Pipeline)**:
    ...
    - Demo project 43 "IT Operations" is seeded with five sample initiatives across New Suggestions / Phase 1 / Phase 3, with the 7th bucket renamed to "2026 Completed Initiatives" — used as the canonical reference for what a department initiative board should look like.
    - Each task / "initiative" captures: suggestedById, goal, implementation (how), rationale (why), impactedDepartmentIds (jsonb array of dept ids), additionalComments, plus a checklist (Point A → Z), labels, assignee, priority, due date.
