...
export const ListRisksResponseItem = zod.object({
  ...
  employeeImpact: zod.string(),
  financialImpact: zod.string(),
  operationalImpact: zod.string(),
  complianceImpact: zod.string(),
